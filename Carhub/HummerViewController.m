...
@interface HummerViewController ()

@end

@implementation HummerViewController
...
{
    static NSString *CellIdentifier = @"HummerCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Hummer'"];
