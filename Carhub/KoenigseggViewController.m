...
#import "KoenigseggViewController.h"
#import "Model.h"
...
@interface KoenigseggViewController ()

@end

@implementation KoenigseggViewController
...
{
    static NSString *CellIdentifier = @"KoenigseggCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Koenigsegg'"];
