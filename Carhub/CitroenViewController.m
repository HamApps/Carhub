...
#import "CitroenViewController.h"
#import "Model.h"
...
@interface CitroenViewController ()

@end

@implementation CitroenViewController
...
{
    static NSString *CellIdentifier = @"CitroenCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Citroen'"];
