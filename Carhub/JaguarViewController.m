...
@interface JaguarViewController ()

@end

@implementation JaguarViewController
...
{
    static NSString *CellIdentifier = @"JaguarCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Jaguar'"];
