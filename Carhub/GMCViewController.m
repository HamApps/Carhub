...
@implementation GMCViewController
...
{
    static NSString *CellIdentifier = @"GMCCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'GMC'"];
