...
@interface SubaruViewController ()

@end

@implementation SubaruViewController
...
{
    static NSString *CellIdentifier = @"SubaruCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Subaru'"];
