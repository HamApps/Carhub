...
#import "PorscheViewController.h"
#import "Model.h"
...
@interface PorscheViewController ()

@end

@implementation PorscheViewController
...
{
    static NSString *CellIdentifier = @"PorscheCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Porsche'"];
