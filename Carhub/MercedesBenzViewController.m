...
#import "MercedesBenzViewController.h"
#import "Model.h"
...
@interface MercedesBenzViewController ()

@end

@implementation MercedesBenzViewController
...
{
    static NSString *CellIdentifier = @"MercedesBenzCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Mercedes-Benz'"];
