...
#import "ChevroletViewController.h"
#import "Model.h"
...
@interface ChevroletViewController ()

@end

@implementation ChevroletViewController
...
{
    static NSString *CellIdentifier = @"ChevroletCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Chevrolet'"];
