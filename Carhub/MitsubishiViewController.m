...
#import "MitsubishiViewController.h"
#import "Model.h"
...
@interface MitsubishiViewController ()

@end

@implementation MitsubishiViewController
...
{
    static NSString *CellIdentifier = @"MitsubishiCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Mitsubishi'"];
