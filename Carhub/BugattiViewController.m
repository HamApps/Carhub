...
#import "BugattiViewController.h"
#import "Model.h"
...
@interface BugattiViewController ()

@end

@implementation BugattiViewController
...
{
    static NSString *CellIdentifier = @"BugattiCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Bugatti'"];
