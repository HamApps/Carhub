...
@interface FiskerViewController ()

@end

@implementation FiskerViewController
...
{
    static NSString *CellIdentifier = @"FiskerCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Fisker'"];
