...
@interface ToyotaViewController ()

@end

@implementation ToyotaViewController
...
{
    static NSString *CellIdentifier = @"ToyotaCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Toyota'"];
