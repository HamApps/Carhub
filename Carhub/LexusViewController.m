...
@interface LexusViewController ()

@end

@implementation LexusViewController
...
{
    static NSString *CellIdentifier = @"LexusCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Lexus'"];
