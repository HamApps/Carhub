...
@interface NissanViewController ()

@end

@implementation NissanViewController
...
{
    static NSString *CellIdentifier = @"NissanCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Nissan'"];
