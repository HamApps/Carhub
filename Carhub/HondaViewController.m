...
@interface HondaViewController ()

@end

@implementation HondaViewController
...
{
    static NSString *CellIdentifier = @"HondaCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Honda'"];
