...
#import "RollsRoyceViewController.h"
#import "Model.h"
...
@interface RollsRoyceViewController ()

@end

@implementation RollsRoyceViewController
...
{
    static NSString *CellIdentifier = @"RollsRoyceCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Rolls-Royce'"];
