...
#import "VolkswagenViewController.h"
#import "Model.h"
...
@interface VolkswagenViewController ()

@end

@implementation VolkswagenViewController
...
{
    static NSString *CellIdentifier = @"VolkswagenCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Volkswawgen'"];
