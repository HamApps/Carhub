...
@interface TeslaViewController ()

@end

@implementation TeslaViewController
...
{
    static NSString *CellIdentifier = @"TeslaCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Tesla'"];
