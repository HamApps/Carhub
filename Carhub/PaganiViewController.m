...
@interface PaganiViewController ()

@end

@implementation PaganiViewController
...
{
    static NSString *CellIdentifier = @"PaganiCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Pagani'"];
