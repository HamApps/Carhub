...
@interface ArashViewController ()

@end

@implementation ArashViewController
...
{
    static NSString *CellIdentifier = @"ArashCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *ArashPredicate = [NSPredicate predicateWithFormat:@"Make = 'Arash'"];
    modelArray = [jsonArray filteredArrayUsingPredicate:ArashPredicate];
