...
#import "LandRoverViewController.h"
#import "Model.h"
...
@interface LandRoverViewController ()

@end

@implementation LandRoverViewController
...
{
    static NSString *CellIdentifier = @"LandRoverCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Land Rover'"];
