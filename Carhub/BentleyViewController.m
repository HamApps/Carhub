...
#import "BentleyViewController.h"
#import "Model.h"
...
@interface BentleyViewController ()

@end

@implementation BentleyViewController
...
{
    static NSString *CellIdentifier = @"BentleyCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Bentley'"];
