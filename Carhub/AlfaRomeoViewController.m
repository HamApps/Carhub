...
#import "AlfaRomeoViewController.h"
#import "Model.h"
...
@interface AlfaRomeoViewController ()

@end

@implementation AlfaRomeoViewController
...
{
    static NSString *CellIdentifier = @"AlfaRomeoCell";
