...
#import "ChryslerViewController.h"
#import "Model.h"
...
@interface ChryslerViewController ()

@end

@implementation ChryslerViewController
...
{
    static NSString *CellIdentifier = @"ChryslerCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Chrysler'"];
