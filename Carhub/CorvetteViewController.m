...
#import "CorvetteViewController.h"
#import "Model.h"
...
@interface CorvetteViewController ()

@end

@implementation CorvetteViewController
...
{
    static NSString *CellIdentifier = @"CorvetteCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Corvette'"];
