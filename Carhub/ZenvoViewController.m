//
//  ZenvoViewController.m
//  Carhub
//
//  Created by Christopher Clark on 7/24/14.
//  Copyright (c) 2014 Ham Applications. All rights reserved.
//

#import "ZenvoViewController.h"
#import "Model.h"
...
@interface ZenvoViewController ()

@end

@implementation ZenvoViewController
...
{
    static NSString *CellIdentifier = @"ZenvoCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Zenvo'"];
