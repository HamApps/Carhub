...
#import "MaseratiViewController.h"
#import "Model.h"
...
@interface MaseratiViewController ()

@end

@implementation MaseratiViewController
...
{
    static NSString *CellIdentifier = @"MaseratiCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Maserati'"];
