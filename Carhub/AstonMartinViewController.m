...
#import "AstonMartinViewController.h"
#import "Model.h"
...
@interface AstonMartinViewController ()

@end

@implementation AstonMartinViewController
...
{
    static NSString *CellIdentifier = @"AstonMartinCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *MakePredicate = [NSPredicate predicateWithFormat:@"Make = 'Aston Martin'"];
    modelArray = [jsonArray filteredArrayUsingPredicate:MakePredicate];
