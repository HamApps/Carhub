...
@interface AudiViewController ()

@end

@implementation AudiViewController
...
{
    static NSString *CellIdentifier = @"AudiCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *MakePredicate = [NSPredicate predicateWithFormat:@"Make = 'Audi'"];
