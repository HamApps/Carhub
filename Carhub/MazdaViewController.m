...
@interface MazdaViewController ()

@end

@implementation MazdaViewController
...
{
    static NSString *CellIdentifier = @"MazdaCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Mazda'"];
