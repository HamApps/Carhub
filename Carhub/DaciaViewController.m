...
@interface DaciaViewController ()

@end

@implementation DaciaViewController
...
{
    static NSString *CellIdentifier = @"DaciaCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Dacia'"];
