...
#import "GumpertViewController.h"
#import "Model.h"
...
@interface GumpertViewController ()

@end

@implementation GumpertViewController
...
{
    static NSString *CellIdentifier = @"GumpertCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Gumpert'"];
