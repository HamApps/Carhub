...
#import "RenaultViewController.h"
#import "Model.h"
...
@interface RenaultViewController ()

@end

@implementation RenaultViewController
...
{
    static NSString *CellIdentifier = @"RenaultCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Renault'"];
