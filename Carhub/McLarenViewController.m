...
#import "McLarenViewController.h"
#import "Model.h"
...
@interface McLarenViewController ()

@end

@implementation McLarenViewController
...
{
    static NSString *CellIdentifier = @"McLarenCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'McLaren'"];
