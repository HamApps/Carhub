...
#import "CaterhamViewController.h"
#import "Model.h"
...
@interface CaterhamViewController ()

@end

@implementation CaterhamViewController
...
{
    static NSString *CellIdentifier = @"CaterhamCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Caterham'"];
