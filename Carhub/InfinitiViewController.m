...
#import "InfinitiViewController.h"
#import "Model.h"
...
@interface InfinitiViewController ()

@end

@implementation InfinitiViewController
...
{
    static NSString *CellIdentifier = @"InfinitiCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Infiniti'"];
