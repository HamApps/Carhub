...
#import "MaybachViewController.h"
#import "Model.h"
...
@interface MaybachViewController ()

@end

@implementation MaybachViewController
...
{
    static NSString *CellIdentifier = @"MaybachCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Maybach'"];
