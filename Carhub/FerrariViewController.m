...
#import "FerrariViewController.h"
#import "Model.h"
...
@interface FerrariViewController ()

@end

@implementation FerrariViewController
...
{
    static NSString *CellIdentifier = @"FerrariCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Ferrari'"];
