...
{
    static NSString *CellIdentifier = @"ArielCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *ArielPredicate = [NSPredicate predicateWithFormat:@"Make = 'Ariel'"];
    modelArray = [jsonArray filteredArrayUsingPredicate:ArielPredicate];
