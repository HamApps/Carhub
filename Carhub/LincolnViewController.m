...
#import "LincolnViewController.h"
#import "Model.h"
...
@interface LincolnViewController ()

@end

@implementation LincolnViewController
...
{
    static NSString *CellIdentifier = @"LincolnCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Lincoln'"];
