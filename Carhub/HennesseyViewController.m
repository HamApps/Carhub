...
#import "HennesseyViewController.h"
#import "Model.h"
...
@interface HennesseyViewController ()

@end

@implementation HennesseyViewController
...
{
    static NSString *CellIdentifier = @"HennesseyCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Hennessey'"];
