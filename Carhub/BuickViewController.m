...
@interface BuickViewController ()

@end

@implementation BuickViewController
...
{
    static NSString *CellIdentifier = @"BuickCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Buick'"];
