...
@interface VolvoViewController ()

@end

@implementation VolvoViewController
...
{
    static NSString *CellIdentifier = @"VolvoCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Volvo'"];
