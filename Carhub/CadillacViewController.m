...
#import "CadillacViewController.h"
#import "Model.h"
...
@interface CadillacViewController ()

@end

@implementation CadillacViewController
...
{
    static NSString *CellIdentifier = @"CadillacCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Cadillac'"];
