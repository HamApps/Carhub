...
#import "LamborghiniViewController.h"
#import "Model.h"
...
@interface LamborghiniViewController ()

@end

@implementation LamborghiniViewController
...
{
    static NSString *CellIdentifier = @"LamborghiniCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Lamborghini'"];
