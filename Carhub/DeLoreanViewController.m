...
#import "DeLoreanViewController.h"
#import "Model.h"
...
@interface DeLoreanViewController ()

@end

@implementation DeLoreanViewController
...
{
    static NSString *CellIdentifier = @"DeLoreanCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'DeLorean'"];
