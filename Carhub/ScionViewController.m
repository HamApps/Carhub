...
@interface ScionViewController ()

@end

@implementation ScionViewController
...
{
    static NSString *CellIdentifier = @"ScionCell";
...
- (void) retrieveData;
{
    ...
    NSPredicate *AlfaRomeoPredicate = [NSPredicate predicateWithFormat:@"Make = 'Scion'"];
